...
{
        // Либовая strcmp работает медленнее, по всей вероятности, из-за попыток использовать sse, безуспешных в
        // ... связи с обработкой преимущественно очень коротких строк - 4-5 байт, а также расходов на вызов.
        int i = 0;
